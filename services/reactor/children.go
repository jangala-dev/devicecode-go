...
// publishes via state/self/software. They are development sentinels for this
// original-reactor branch; build tooling can override them later by adding a
// same-package init file when the release wiring is introduced.
var (
